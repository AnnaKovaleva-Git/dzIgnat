...
export const deleteAffair = (array: AffairType[], _id: number): AffairType[] => { // need to fix any
    return array.filter(affair => affair._id !== _id) // need to fix
}
